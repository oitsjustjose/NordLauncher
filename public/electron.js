...
if (!app.isDefaultProtocolClient('nordlauncher')) {
  app.setAsDefaultProtocolClient('nordlauncher');
}
...
app.setPath('userData', path.join(app.getPath('appData'), 'nordlauncher_data'));
